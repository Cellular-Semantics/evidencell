...
| Defining markers | Cck, Calb1, Cnr1 | [1], [2], [3], [4], [5], [6] |
...
- **Cnr1 defining marker — perisomatic innervation:** immunohistochemistry · Vereczki et al. 2016 · [5]
  ...
  > — Vereczki et al. 2016, Basolateral amygdala and corticobasal cell types · [5] <!-- quote_key: 16327247_9b5e6962 -->

- **Cnr1 defining marker — CB1R+ basket cell identity:** electrophysiology + immunofluorescence · Rovira-Esteban et al. 2019 · [6]
  ...
  > — Rovira-Esteban et al. 2019, Basolateral amygdala and corticobasal cell types · [6] <!-- quote_key: 204835327_91ea43a5 -->
...
- **Cnr1:** Listed as a defining marker in [3], [5], [6] based on immunohistochemistry and electrophysiology/immunofluorescence. Vereczki et al. 2016 [5] confirmed CCK/CB1BC cells by CB1 immunoreactivity on axon terminals in mouse BLA; Rovira-Esteban et al. 2019 [6] confirmed CCK/CB1R+ basket cells using electrophysiology + immunofluorescence on EYFP-labelled interneurons. Atlas precomputed expression confirms Cnr1 transcript at mean 12.36 (98.5th pct, tier-2 reliable) for 0664 Sncg Gaba_1 [CS20230722_CLUS_0664]. Evidence chain is solid across protein and transcript levels.
...
| [3] | Woodruff & Sah 2007 | [17234587](https://pubmed.ncbi.nlm.nih.gov/17234587/) | Cck and Cnr1 defining markers |
| [4] | Totty et al. 2024 | [39463931](https://pubmed.ncbi.nlm.nih.gov/39463931/) | Cck defining marker |
| [5] | Vereczki et al. 2016 | [27013983](https://pubmed.ncbi.nlm.nih.gov/27013983/) | Cnr1 defining marker, CCK/CB1BC perisomatic innervation |
| [6] | Rovira-Esteban et al. 2019 | [31636080](https://pubmed.ncbi.nlm.nih.gov/31636080/) | Cnr1 defining marker, CCK/CB1R basket cell identity |
...
verdict:
  ...
  rationale: >
    Sncg Gaba subclass confirmed by scRNA-seq annotation transfer (F1=0.59 at SUBCLASS
    level in at_run_20260609_hochgerner2023_amygdala_mmc_wmbv1; CS20230722_SUBC_047);
    neuropeptide_Cck CONSISTENT (precomputed mean 11.15, 98.3rd pct, tier-2 reliable)
    and nt_type CONSISTENT (GABA). 1 of 2 marker-property comparisons CONSISTENT
    (neuropeptide_Cck CONSISTENT; negative_marker_Pvalb NOT_ASSESSED).
    CLUSTER-level F1=0.06 for CS20230722_CLUS_0664 reflects dispersal across 5
    Sncg Gaba_1 sibling clusters; cluster nomination is speculative pending
    BLA-specific targeted annotation-transfer from CCK basket cell-enriched source data.
  reconciliation_note: >
    CLASS-level AT overlap with bla_vip_calretinin_interneuron (CS20230722_CLAS_06
    ...
    interneurons are molecularly distinct by marker profile: Cck/Cnr1 vs Vip/Calb2).
  lit_to_lit_edges: []
  unresolved_questions:
    ...
    - "Confirm Calb1 expression in CS20230722_CLUS_0664 from precomputed stats — no marker_Calb1 property comparison present."
    - "Confirm Pvalb absence in CS20230722_CLUS_0664 from precomputed stats — negative_marker_Pvalb currently NOT_ASSESSED."
```
<!-- verdict-block-end -->
