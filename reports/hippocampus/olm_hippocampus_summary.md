...
**Annotation transfer.** A single MapMyCells run (cell_type_mapper v1.7.1, default
parameters, raw normalisation) provides the AT evidence used across all five
candidate edges. Source dataset: 46 OLM scRNA-seq cells from GEO:GSE124847
(Winterer et al. 2019 [7]), Mus musculus. Target atlas: WMBv1 (CCN20230722),
Mus musculus. Best F1 across the run was 0.67 at SUPERTYPE level (43/46 cells
mapped to SUPT_0216 Sst Gaba_3); CLUSTER-level best was F1=0.47 to CLUS_0768.
Bootstrap threshold = 0.8; n_cells_total = 46. Per-cluster F1 values appear in
the Results section (Evidence support tables).
...
*Generated by evidencell `860919b` at 2026-04-30T09:04:15+00:00 from
[/Users/do12/Documents/GitHub/BICAN_agentic_framework_planning/evidencell/kb/draft/hippocampus/hippocampus_OLM.yaml](/Users/do12/Documents/GitHub/BICAN_agentic_framework_planning/evidencell/kb/draft/hippocampus/hippocampus_OLM.yaml).*
