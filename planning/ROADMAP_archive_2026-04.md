...
Extracted to [planning/candelabrum_pilot_lessons.md](candelabrum_pilot_lessons.md).
...
**Design discussion**: [planning/adaptive_mapping_loop_design.md](adaptive_mapping_loop_design.md)
...
**Design discussion**: [planning/workflow_architecture_design.md](workflow_architecture_design.md)
**Status**: 🔲 Pending
...
See [planning/workflow_architecture_design.md](workflow_architecture_design.md)
...
See [planning/schema_self_contained_references.md](schema_self_contained_references.md) for full proposal.
