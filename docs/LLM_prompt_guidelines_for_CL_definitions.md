<!--
Source: https://github.com/obophenotype/cell-ontology/blob/master/docs/LLM_prompt_guidelines_for_CL_definitions.md
Synced: 2026-04-30 (byte-identical to upstream master). Re-sync rather than edit locally.
-->
